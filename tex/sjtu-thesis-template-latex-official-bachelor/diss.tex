...
\studentnumber{5130309721}
\major{计算机科学与技术}

% 英文封面内容(关注内容而不是表现形式)
\englishtitle{Connection between Conference in Academic Big Data}
\englishauthor{\textsc{Yiyang Li}}
\englishadvisor{Prof. \textsc{Minyou Wu}}
